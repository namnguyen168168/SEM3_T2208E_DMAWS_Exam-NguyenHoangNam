        ...
        (window.templateCustomizer &&
          ...
          'light' === s
            ? (l.classList.add('bx-sun'),
              new bootstrap.Tooltip(l, { title: 'Light Mode', fallbackPlacements: ['bottom'] }))
            : 'dark' === s
            ? (l.classList.add('bx-moon'),
              new bootstrap.Tooltip(l, { title: 'Dark Mode', fallbackPlacements: ['bottom'] }))
            : (l.classList.add('bx-desktop'),
              new bootstrap.Tooltip(l, { title: 'System Mode', fallbackPlacements: ['bottom'] }))),
        ...
        setTimeout(function () {
          ...
          s.on('focus', function () {
            a.hasClass('container-xxl')
              ? (a.find(e).addClass('container-xxl'), e.removeClass('container-fluid'))
              : a.hasClass('container-fluid') &&
                (a.find(e).addClass('container-fluid'), e.removeClass('container-xxl'));
          });
        }, 10),
        s.length &&
          ((t = function (n) {
